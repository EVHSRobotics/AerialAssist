 ...
 * floating around.
 */
public class RobotMap { //below are the ports for each of the motor / sensor assignments   
   
    //Victors or talons plugged into digital sidecar - motor controllers
    ...
    //Sensors plugged into digital sidecar I/O 
