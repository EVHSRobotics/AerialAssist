...
public class Vision extends CommandBase {
    ...
    //Score limits for target identification
    final int RECTANGULARITY_LIMIT = 40;
    final int ASPECT_RATIO_LIMIT = 55;
    //Score limitd for hot target 
    ...
    public Vision() {
        requires(visionCamera);
    }

    // Called just before this Command runs the first time
    protected void initialize() {
        visionCamera.cc.addCriteria(MeasurementType.IMAQ_MT_AREA, AREA_MINIMUM, 65535, false);
